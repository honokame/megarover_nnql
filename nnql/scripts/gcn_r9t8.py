...
#データ読み込み
train_df = 'dataset/r9t8/scan' + sys.argv[1] + '/feature' + sys.argv[1] + '.csv'
train_pf = 'dataset/statusclass' + sys.argv[1] + '.csv'
test_df = 'dataset/r9t8/scan' + sys.argv[2] + '/feature' + sys.argv[2] + '.csv'
test_pf = 'dataset/statusclass' + sys.argv[2] + '.csv'
model_f = 'dataset/model_r9t8_' + sys.argv[1] + sys.argv[2] + '.pth'
...
for data, place in zip(train_data, train_place):
  label = place[4]-1#5,6,7                            # ground truth
  data = data.tolist()  
...
#テストデータ読み込み
test_data = np.loadtxt(fname=test_df,  dtype="int",  delimiter=",")
test_place = np.loadtxt(fname=test_pf, dtype="int", delimiter=",")

#テストデータグラフ作成
testset = []
for data, place in zip(test_data, test_place):
  label = place[4]-1                            # ground truth
  data = data.tolist() 
  feature_list = [data[1:73],data[73:145],data[145:217],data[217:289],data[289:361],data[361:433],data[433:505],data[505:577],data[577:649]] #r9t8 
  #feature_list = [data[1:109],data[109:217],data[217:325],data[325:433],data[433:541],data[541:649],data[649:757],data[757:865],data[865:973]]#r9t12
  #feature_list = [data[1:41],data[41:81],data[81:121],data[121:161],data[161:201],data[201:241],data[241:281],data[281:321],data[321:361]] #r5t8  
