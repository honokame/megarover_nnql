...
if __name__ == '__main__':
    ...
    status_csv = 'NNQL_random2_fw/groundtruth.csv'
    #scan_csv = 'scan' + args[1] + '.csv'
    f_status = open(status_csv, 'w')
    #f_scan = open(scan_csv,'w')
    result_csv = 'NNQL_random2_fw/result.csv'
    f_result = open(result_csv, 'w')
    qdata_path = 'NNQL_random2_fw/Qdatabase'
    episode = 1  # 901
    max_episode = 600
    step = 1
    ...
    while (episode < max_episode+1):
        ...
        while (step < 5):
            ...
            # action = action_list[action_index]
                ...
                q_average = list([0]*3)
            # action_index = np.random.randint(0, 2) #frontier,wall
                knn_list = None
