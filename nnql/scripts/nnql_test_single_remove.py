...
def get_occupancy(): #12520:100%,10016:80%
...
def simple_start():
  x = np.random.uniform(7.2,7.5) #0.2
  y = np.random.uniform(3.0,4.9) #1.0
  yaw = np.random.randint(-45,45) #45
  return x,y,yaw
...
if __name__ == '__main__':
  ...
  Qdatabase = NNQL.mk_Qdatabase(600) #Qデータベース作成
  ...
  while(episode < max_episode+1):
    ...
    start_x, start_y, start_yaw = simple_start()
