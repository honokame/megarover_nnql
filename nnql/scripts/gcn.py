...
#訓練データ読み込み
train_data = np.loadtxt(fname="data/train37_feature.csv",  dtype="int",  delimiter=",")
train_place = np.loadtxt(fname="data/train37_statusclass.csv", dtype="int", delimiter=",")

#訓練データグラフ作成
trainset = []
for data, place in zip(train_data, train_place):
  label = place[6]#5,6,7                            # ground truth
  data = data.tolist() 
  feature_list = [data[1:73],data[73:145],data[145:217],data[217:289],data[289:361],data[361:433],data[433:505],data[505:577],data[577:649]]
  #print(feature_list)
  #print(label)
...
#テストデータ読み込み
test_data = np.loadtxt(fname="data/test1_feature.csv",  dtype="int",  delimiter=",")
test_place = np.loadtxt(fname="data/test1_statusclass.csv", dtype="int", delimiter=",")

#テストデータグラフ作成
testset = []
for data, place in zip(test_data, test_place):
  label = place[6]                            # ground truth
  data = data.tolist() 
  feature_list = [data[1:73],data[73:145],data[145:217],data[217:289],data[289:361],data[361:433],data[433:505],data[505:577],data[577:649]]
  #print(feature_list)
  #print(label)
