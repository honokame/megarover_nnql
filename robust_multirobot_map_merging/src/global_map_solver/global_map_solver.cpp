...
const std::string GlobalMapSolver::CONSISTENCY_MATRIX_FILE_NAME = std::string("/home/chinourobot/results/consistency_matrix.clq.mtx");
const std::string GlobalMapSolver::CONSISTENCY_LOOP_CLOSURES_FILE_NAME = std::string("/home/chinourobot/results/consistent_loop_closures.txt");
